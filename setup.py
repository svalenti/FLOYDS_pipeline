...
setup(
    ...
    install_requires=['numpy==1.22.0','astropy==2.0.16','pyraf==2.1.15','matplotlib==2.2.4', 'xhtml2pdf==0.2.4', 'pathlib2==2.3.5', 'requests==2.22.0', 'stsci.tools==3.6.0'],
    packages=['floyds'],
    package_dir={'':'src','doc':'doc'},
    package_data = {'floyds' : ["standard/MAB/*","standard/ident/*","standard/cat/*","standard/extinction/*",\
                                "standard/ident/en*/*","standard/ident2/en*/*","standard/ident/*",\
